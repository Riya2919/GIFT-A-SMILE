  ...
  return (
    <>
      ...
      <main>
        ...
        <section className='py-3 sm:py-5 md:py-8'>
          <div className='w-3/4 mx-auto'>
            <h2 className='uppercase text-center font-semibold mb-3 sm:font-bold sm:text-lg md:mb-5 lg:text-xl lg:mb-5 xl:text-2xl xl:mb-8'>Our Mission</h2>
            <div className='bg-slate-800 w-5/6 mx-auto rounded-lg hover:scale-105 transition-all ease-in-out sm:w-3/5 md:flex md:w-2/3 md:p-5'>
              ...
              <div className='md:w-3/5 md:my-auto'>
                <p className='text-center text-white text-sm px-2 pb-2 sm:px-4 lg:text-base'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. In voluptates nesciunt aliquid minus a ea provident aliquam iusto fugit deserunt.</p>

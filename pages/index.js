      ...
      <main>
        <section className='relative'>
          ...
          <div className='absolute bottom-3 flex justify-evenly w-screen sm:bottom-5 lg:bottom-8 xl:bottom-10'>
            <div className='bg-green-400 w-1/4 opacity-80 rounded-lg hover:scale-110 transition-all ease-in-out p-1 lg:p-3'>
              <h1 className='text-center font-semibold sm:font-bold lg:text-xl'>420+</h1>
              <p className='text-center text-sm sm:text-base lg:text-lg'>dolor sit amet consectetur</p>
            </div>
            <div className='bg-green-400 w-1/4 opacity-80 rounded-lg hover:scale-110 transition-all ease-in-out p-1 lg:p-3'>
              <h1 className='text-center font-semibold sm:font-bold lg:text-xl'>420+</h1>
              <p className='text-center text-sm sm:text-base lg:text-lg'>dolor sit amet consectetur</p>
        ...
        <section className='py-5'>
          ...
          <div className='space-y-5 w-screen md:flex md:space-y-0 md:flex-wrap'>
            <div className='w-3/4 sm:w-2/5 mx-auto md:p-3 lg:w-1/4 lg:p-1'>
              <div className='bg-gradient-to-tr from-black to-gray-500 opacity-80 rounded-lg p-3 shadow-xl hover:scale-105 transition-all ease-in-out'>
